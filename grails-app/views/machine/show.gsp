...
<html>
    ...
    <body>
        ...
        <div id="show-machine" class="content scaffold-show" role="main">
            ...
            <f:display bean="machine" />
            <g:form resource="${this.machine}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.machine}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
